...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['confirm_delete'])) {
        $sql = "DELETE FROM hc_users WHERE user_id = ?";
...
$sql = "SELECT user_name FROM hc_users WHERE user_id = ?";
$stmt = $conn->prepare($sql);
$stmt->bind_param("i", $user_id);
$stmt->execute();
    ...
    <div class="main-content">
      ...
      <main class="dashboard-main">
        <div class="add-service-section">
            ...
            <?php endif; ?>
            <p>Are you sure you want to delete the user: <strong><?php echo htmlspecialchars($user['user_name']); ?></strong>?</p>
